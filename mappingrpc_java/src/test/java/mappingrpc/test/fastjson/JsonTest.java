...
public class JsonTest {
	...
	public void test_genericsReflect() throws Throwable {
		Class<?> clazz = Class.forName("mappingrpc.test.centerserver.service.GenericeResultService");
	...
	@Test
	public void test_fastJsonGenerics() throws Throwable {
		Class<?> clazz = Class.forName("mappingrpc.test.centerserver.service.GenericeResultService");
		Method method = clazz.getMethod("queryUser", null);
		Type returnType = method.getGenericReturnType();
		...
		ModelResult<User> result = JSON.parseObject(resultJson, returnType);
